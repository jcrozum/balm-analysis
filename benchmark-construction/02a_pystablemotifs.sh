...
./venv/bin/python3 run_bench.py $TIMEOUT models-bbm bench_pystablemotifs_construction.py -p 6

zip -r perf-pystablemotifs-`hostname`.zip _run_* 
rm -rf _run_*