...
result_files = {
    "bbm": "../benchmark-control/results-bbm.tsv",
}
...
simple_cumulative_figure(
    ...
    tool_columns, 
    colors, 
    './figures/control_cumulative.pdf', 
    'Completed control benchmarks'
)
simple_scatter_figure(
    ...
    f"./figures/control_scatter.pdf",
    f"Biobalm vs. pystablemotifs; Target control"
)